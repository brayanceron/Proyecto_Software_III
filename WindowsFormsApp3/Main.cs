...
namespace WindowsFormsApp3
{
    ...
    public partial class Main : Form
    {
        ...
        public Main(string _name,string _user,string _passwor)
        {
            InitializeComponent();
            string[] v = { "a", "v"};
            ...
            //ojo si user es nulo u otro valor cerrar de inmediato el programa
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (resultados.Read())
                {
                    ...
                    if (dd == 0)
                    {
                        //Pagar_Inversion nuevo = new Pagar_Inversion(user);
        ...
        {
            Informacion_Clientes nuevo = new Informacion_Clientes(1,user);
            nuevo.Show();
        ...
        {
            Informacion_Clientes nuevo = new Informacion_Clientes(3,user);
            nuevo.Show();
        }
        ...
        private void btn_administrar_transacciones_Click_1(object sender, EventArgs e)
        {
            ...
            int b = al.Next(1,3);
            Informacion_Clientes nuevo = new Informacion_Clientes(b,user);
            nuevo.Show();
        }
        ...
        private void btn_administrar_cronogramas_CLICK(object sender, EventArgs e)
        {
            Random al = new Random();
            int b = al.Next(1, 3);
            Generar_Cronogramas nuevo = new Generar_Cronogramas(b);
            nuevo.Show();
        }
        ...
        private void btn_admin_transac_Click(object sender, EventArgs e)
        {
            Random al = new Random();
            int b = al.Next(1, 3);
            Administrar_Transaciones nuevo = new Administrar_Transaciones(b,user);
            nuevo.Show();            
        }

        private void btn_admin_inv_CLICK(object sender, EventArgs e)
        {
            Administrar_Transaciones nuevo = new Administrar_Transaciones(2,user);
            nuevo.Show();
        }

        private void btn_admin_pre_Click(object sender, EventArgs e)
        {
            Administrar_Transaciones nuevo = new Administrar_Transaciones(1,user);
            nuevo.Show();
        }
        ...
        private void btn_configuracion_Click(object sender, EventArgs e)
        {
            ...
            Config configurar = new Config(name, user, password,cadena);
